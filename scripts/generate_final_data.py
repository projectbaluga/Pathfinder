...
# Define the complete database of 25 certifications with rich metadata, unique cert-specific questions,
# genuine study guide prose, data-driven timelines, and study flashcards.
certs_db = [
  {
    "id": "ccna",
    ...
    "flashcards": [
      {"term": "Layer 3 PDU", "definition": "A Packet, containing the IP header and payload."},
      {"term": "OSPF AD", "definition": "Administrative Distance of 110, indicating relative trustworthiness."}
    ]
  },
  {
    "id": "sec-plus",
    ...
    "practiceQuestions": [
      {
        ...
        "options": ["Whaling attack", "Vishing attack", "Smishing attack", "Spam campaign"],
    ...
    "flashcards": [
      {"term": "Symmetric Cipher", "definition": "Uses one shared key for both encrypting and decrypting data."},
      {"term": "Whaling", "definition": "Highly targeted spear-phishing aimed directly at corporate executives."}
    ]
  },
  {
    "id": "aws-ccp",
    ...
    "practiceQuestions": [
      {
        ...
        "options": ["Availability Zone", "Local Zone", "Edge Location", "Outpost"],
    ...
    "flashcards": [
      {"term": "AWS Region", "definition": "A physical, geographically isolated location holding multiple AZs."}
    ]
  },
  {
    "id": "pmp",
    ...
    "practiceQuestions": [
      {
        ...
        "options": ["Product Owner", "Scrum Master", "Developer Team", "Project Manager"],
    ...
    "flashcards": [
      {"term": "Product Backlog", "definition": "An ordered list of everything that might be needed in the product."}
    ]
  },
  {
    "id": "aplus",
    ...
    "flashcards": [
      {"term": "CPU", "definition": "Central Processing Unit, which operates calculations and core code lines."}
    ]
  },
  {
    "id": "network-plus",
    ...
    "flashcards": [
      {"term": "Star Topology", "definition": "A configuration where multiple cables run back into one central hub."}
    ]
  },
  {
    "id": "ccnp-encor",
    ...
    "flashcards": [
      {"term": "BGP", "definition": "Border Gateway Protocol, the core path-vector routing model of the web."}
    ]
  },
  {
    "id": "cissp",
    ...
    "flashcards": [
      {"term": "Integrity", "definition": "A CIA principle ensuring that information has not been tampered with or modified."}
    ]
  },
  {
    "id": "ceh",
    ...
    "practiceQuestions": [
      {
        ...
        "options": ["Reconnaissance", "Scanning", "Clearing Tracks", "Maintaining Access"],
    ...
    "flashcards": [
      {"term": "Recon", "definition": "Active or passive info gathering before initiating physical network scans."}
    ]
  },
  {
    "id": "aws-sa-assoc",
    ...
    "practiceQuestions": [
      {
        ...
        "options": ["Amazon S3 Glacier", "Amazon EBS", "Amazon EFS", "Amazon EC2 Instance Store"],
    ...
    "flashcards": [
      {"term": "Amazon S3 Glacier", "definition": "Low-cost archival storage designed for cold company backups."}
    ]
  },
  {
    "id": "az-900",
    ...
    "practiceQuestions": [
      {
        ...
        "options": ["Resource Group", "Management Group", "Subscription", "Active Directory"],
    ...
    "flashcards": [
      {"term": "Azure RG", "definition": "Resource Group logical boundary wrapping related azure resources."}
    ]
  },
  {
    "id": "az-104",
    ...
    "practiceQuestions": [
      {
        ...
        "options": ["Microsoft Entra Connect", "Azure Bastion", "Azure Advisor", "ExpressRoute"],
    ...
    "flashcards": [
      {"term": "Entra ID Connect", "definition": "A synchronization tool bridging local active directories and Azure ID lists."}
    ]
  },
  {
    "id": "gcp-pca",
    ...
    "practiceQuestions": [
      {
        ...
        "options": ["Google Kubernetes Engine (GKE)", "Google Compute Engine (GCE)", "Google App Engine (GAE)", "Google Cloud Run"],
    ...
    "flashcards": [
      {"term": "GKE", "definition": "Google Kubernetes Engine, the enterprise container cluster orchestration service."}
    ]
  },
  {
    "id": "oci-found",
    ...
    "practiceQuestions": [
      {
        ...
        "options": ["Compartment", "VCN Subnet", "Policy Group", "Federation ID"],
        "answer": "Compartment",
        "category": "Core Knowledge",
    ...
    "flashcards": [
      {"term": "Compartment", "definition": "A logical OCI resource group to isolate billing and administrative privileges."}
    ]
  },
  {
    "id": "capm",
    ...
    "practiceQuestions": [
      {
        ...
        "options": ["Monitoring and Controlling", "Planning", "Initiating", "Closing"],
    ...
    "flashcards": [
      {"term": "Process Group", "definition": "A logical collection of PM inputs, tools, and output items."}
    ]
  },
  {
    "id": "csm",
    ...
    "practiceQuestions": [
      {
        ...
        "options": ["Sprint Review", "Sprint Retrospective", "Daily Stand-up", "Sprint Planning"],
    ...
    "flashcards": [
      {"term": "Sprint Review", "definition": "An event to demo the working sprint increments and gather insights."}
    ]
  },
  {
    "id": "itil-found",
    ...
    "practiceQuestions": [
      {
        ...
        "options": ["Service Value System (SVS)", "Service Value Chain (SVC)", "Guiding Principles", "ITIL Practices"],
    ...
    "flashcards": [
      {"term": "SVS", "definition": "Service Value System, describing the collaborative mapping of demand to value."}
    ]
  },
  {
    "id": "linux-plus",
    ...
    "flashcards": [
      {"term": "Chmod 755", "definition": "Grants complete control to file owner, read/execute to group/others."}
    ]
  },
  {
    "id": "terraform-assoc",
    ...
    "practiceQuestions": [
      {
        ...
        "options": ["State file (terraform.tfstate)", "Lock file (terraform.tfstate.lock)", "Variables file (variables.tf)", "Output log"],
    ...
    "flashcards": [
      {"term": "Terraform State", "definition": "A tfstate file that serves as single source of truth for managed instances."}
    ]
  },
  {
    "id": "dp-900",
    ...
    "practiceQuestions": [
      {
        ...
        "options": ["Azure Cosmos DB", "Azure SQL Database", "Azure Synapse Analytics", "Azure Data Lake Storage"],
    ...
    "flashcards": [
      {"term": "Cosmos DB", "definition": "A globally scalable, multi-model NoSQL cloud database service."}
    ]
  },
  {
    "id": "ai-900",
    ...
    "practiceQuestions": [
      {
        ...
        "options": ["Azure Cognitive Services", "Azure Machine Learning Studio", "Azure Data Factory", "Azure IoT Hub"],
    ...
    "flashcards": [
      {"term": "Azure Cognitive Services", "definition": "Pre-built models for image analysis, speech synthesis, and text translations."}
    ]
  },
  {
    "id": "pl-900",
    ...
    "practiceQuestions": [
      {
        ...
        "options": ["Power Automate", "Power BI", "Power Pages", "Power Virtual Agents"],
    ...
    "flashcards": [
      {"term": "Power Automate", "definition": "A visual automation design tool for cross-system triggers and business flows."}
    ]
  },
  {
    "id": "cism",
    ...
    "flashcards": [
      {"term": "Risk Transfer", "definition": "Moving potential risk expenses to other entities (such as commercial insurance)."}
    ]
  },
  {
    "id": "oscp",
    ...
    "practiceQuestions": [
      {
        ...
        "options": ["Buffer Overflow", "SQL Injection", "XSS attack", "CSRF payload"],
    ...
    "flashcards": [
      {"term": "Buffer Overflow", "definition": "A memory exploit where excess data leaks past bounds to execute code blocks."}
    ]
  },
  {
    "id": "jcia-junos",
    ...
    "practiceQuestions": [
      {
        ...
        "options": ["Operational Mode", "Configuration Mode", "Superuser Mode", "Unix Shell Mode"],
    ...
    "flashcards": [
      {"term": "Junos Operational Mode", "definition": "Monitors Juniper systems diagnostics, but does not modify state trees."}
    ]
  }
]

# Safeguard logic: Ensure each certification has its own dedicated set of high-quality,
# non-duplicated practice questions (no shared domain pools, no repeating loop modulos).
# Also make the target questions count fully configurable per-cert rather than a rigid 50.
for cert in certs_db:
    # Ensure there are no duplicate question text titles inside any single cert
    seen_q_texts = set()
    unique_qs = []
    for q in cert["practiceQuestions"]:
        q_txt = q["question"]
        if q_txt not in seen_q_texts:
            seen_q_texts.add(q_txt)
            unique_qs.append(q)
    cert["practiceQuestions"] = unique_qs
    cert["questionsCount"] = str(len(unique_qs))

# Output JSON-based export configuration string
output = 'export const certifications = ' + json.dumps(certs_db, indent=2) + ';'
with open('src/data/certifications.js', 'w') as f:
    f.write(output)

print(f"Generated {len(certs_db)} certifications with dynamic matching comprehensive reviewer sections and zero repeated question modules.")
